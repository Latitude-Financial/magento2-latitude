...
class Api extends \Magento\Framework\Model\AbstractModel
{
     ...
     */
    protected function requestAuthToken($storeId = null, $methodCode = null)
    {
     ...
     */
    protected function stripJSON($requestBody)
    {
        $pattern = '/{"|":{"|","|":"|"},"|}],"|":|\[{"|"}}],"|}}|"}]"|},|,"|"}}|"}/';
        $replacement = '';
     ...
     */
    protected function getJSONsignature($jsn, $apiSecret)
    {
     ...
     * @param string $dob
     */
    protected function sanitizeDOB($dob)
    {
        if ($dob === '') {
            return $dob;
        }
     ...
     */
    protected function createOnlinePurchase($authToken, $lastOrder)
    {
     ...
     * @param string $reason
     */
    protected function refund($order, $transactionId, $amount, $reason)
    {
     ...
     * @param object $order
     */
    protected function checkStatus($order)
    {
     ...
     * @param string $apiSecret
     */
    protected function generateSignatureFromString($str, $apiSecret)
    {
     ...
     * @param object $lastOrder
     */
    protected function createLCPurchase($lastOrder)
    {
     ...
     */
    protected function verifyLCPurchase($order_id, $transactionReference, $gatewayReference)
    {
     ...
     * @param string $reason
     */
    protected function refundLCOrder($order, $transactionId, $gatewayReference, $amount, $reason)
    {
     ...
     * @param string $reason
     */
    protected function captureLCOrder($order, $transactionId, $gatewayReference, $amount, $reason)
    {
     ...
     * @param float $amount
     */
    protected function voidLCOrder($order, $transactionId, $gatewayReference, $amount)
    {
